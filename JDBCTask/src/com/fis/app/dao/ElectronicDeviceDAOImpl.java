...
public class ElectronicDeviceDAOImpl implements IElectronicDeviceDAO {
	...
	@Override
	public List<ElectronicDevice> getDeviceBasedOnPriceRangeAndType(int range1, int range2, String type,List<ElectronicDevice> list) {
		// TODO Auto-generated method stub
		list = list.stream().filter(ed1->{
